...
export const MOVES: Record<string, MeleeMoveDef> = {
  ...
  // --- especiais dos outros personagens (ver data/characters.ts) ---
  novaArcana: {
    id: 'novaArcana',
    pose: 'nova',
    startup: 12,
    ...
    special: true,
    sfx: 'cast_electric',
    effects: [{ k: 'ring', r: 3.2, ticks: 14, fx: 'necro' }],
  },
  socoSismico: {
    id: 'socoSismico',
    pose: 'slamGround',
  ...
  raioLaser: {
    ...
    active: 18,
    recovery: 14,
    hitbox: { x0: 0.3, x1: 10, y0: 0.3, y1: 2.6, zTol: 0.5 },
    hit: {
      damage: 9,
      dtype: 'fire',
      knockback: 1.5,
    ...
    special: true,
    sfx: 'zap',
    effects: [{ k: 'beam', length: 10, y: 1.3, every: 3 }],
  },
  furiaMutante: {
    id: 'furiaMutante',
    pose: 'roar',
    ...
    sfx: 'roar',
    effects: [
      { k: 'power', power: 'rage', s: 6 },
      { k: 'ring', r: 2.6, ticks: 14, fx: 'toxicPool' },
    ],
  },
