...
```
Um robô contra o apocalipse zumbi: socos, armas, magias e chefes gigantes.
```
...
• Sem anúncios, sem compras e sem coleta de dados. Joga offline.
...
```
One robot vs. the zombie apocalypse: punches, guns, magic and giant bosses.
```
...
• No ads, no purchases and no data collection. Plays offline.
...
| -------------------------------------------------- | ------------------------------------------------------ |
| `icon-512.png`                                     | Ícone do app (512×512) / App icon                      |
| `feature-graphic-1024x500.png`                     | Recurso gráfico (1024×500) / Feature graphic           |
